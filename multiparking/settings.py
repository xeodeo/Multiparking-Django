...
MIDDLEWARE = [
    ...
    'multiparking.middleware.DatabaseErrorMiddleware',
    'multiparking.middleware.SecurityHeadersMiddleware',
    'multiparking.middleware.NoCacheAfterLogoutMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'multiparking.context_processors.cuponera_context',
            ],
        },
    },
]
